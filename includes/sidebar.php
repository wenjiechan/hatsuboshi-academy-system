...
$producer_nav = [
    ['label' => 'Home', 'url' => '/gakumas-sms/producer/dashboard.php', 'icon' => 'bi-house-heart', 'page' => 'dashboard.php'],
    [
        'label' => 'Students',
...
$admin_nav = [
    ...
    ['label' => 'Users', 'url' => '/gakumas-sms/admin/users.php', 'icon' => 'bi-person-gear', 'page' => 'users.php'],
...
<aside class="app-sidebar offcanvas-xl offcanvas-start" tabindex="-1" id="mobileSidebar"
    ...
    <nav class="sidebar-nav">
        ...
        <?php $active_pages = $item['pages'] ?? [$item['page']]; ?>
        <a href="<?= htmlspecialchars($item['url']) ?>"
            class="sidebar-link <?= in_array($current_page, $active_pages, true) ? 'active' : '' ?>">
