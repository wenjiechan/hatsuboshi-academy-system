...
<main class="dashboard-main students-main">
    <section class="section-heading students-toolbar">
        ...
        <a href="/gakumas-sms/admin/student_add.php" class="btn btn-primary students-add-button">
                            ...
                            <?php foreach ($students as $student): ?>
                                ...
                                <tr class="student-row"
                                    ...
                                    <td class="text-end student-actions">
                                        ...
                                        <?php else: ?>
                                            <a href="/gakumas-sms/admin/student_delete.php?id=<?= $student_id ?>" class="danger" aria-label="Remove <?= htmlspecialchars($student['name'], ENT_QUOTES, 'UTF-8') ?>">
